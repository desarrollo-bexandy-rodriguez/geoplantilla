...
class WyzBusinessPost extends WyzBusinessPostOverridden {
	...
	private static function wyz_get_business_header( $is_grid ){
		...
		<div class="sin-bordes sin-busi-post<?php echo $is_grid ? ' bus-post-grid' : '';
			...
			<div class="head fix con-bordes" style="border: 1px solid #ececec !important;">
			<?php if ( $sticky ) {?>
	...
	private static function wyz_get_business_content( $business_data, $is_grid ){
		...
		<div class="content con-bordes" style="padding: 0px !important; border: 1px solid #ececec !important; margin-top: 15px !important;" >
