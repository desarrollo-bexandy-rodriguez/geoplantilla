...
function wyz_cat_type_columns( $defaults ) {
	...
	$defaults['map_icon'] = esc_html__( 'Map Icon', 'wyzi-business-finder' );
	return $defaults;
}
...
function wyz_generate_map_icons( $term_id, $tt_id ) {
	...
	if ( isset( $icon_uploaded ) && ! empty( $icon_uploaded ) ) {
		...
		$source3 = imagecreatetruecolor( 55, 55 );
		$source4 = imagecreatetruecolor( 60, 67 );
		...
		imagecopy( $source3, $temp_img_3, 15, 6, 0, 0, 55, 55 );
		imagecopy( $source4, $temp_img_4, 5, 7, 0, 0, 60, 67 );
