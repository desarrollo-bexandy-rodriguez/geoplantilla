...
= 1.3 =
* Add html & banner link filters 

= 1.2.7 =
* Fix impression per person issue

= 1.2.6 =
* Fix log per day issue

= 1.2.5 =
* Improve frontend javascript
* Remove the required link field in banner section

= 1.2.4 =
* Fix the confliction of featured image between theme and the plugin

= 1.2.3.1 =
* Update Mobile detection code
